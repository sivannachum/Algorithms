...
Two representations of DGraphAdjList, different from the ones in the DGraphs folder.
These run DFS using colored vertices, keep track of colored edges, and can construct the DFS tree.
