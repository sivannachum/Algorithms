...
public class GraphDFSAdjListMain {
    //-------------------------------------
    // Main: 		unit test
    ...
    //              add or remove edges between the vertices of a graph, check for an edge in the graph, add or remove vertices in the graph,
    //              run dfs on the graph,
    //              print the graph or properties of it, write the graph to a file or read the graph from a file, or quit
    // Method:	    keeps a GraphDFSAdjList object and invokes its methods to perform requests
    //-------------------------------------
    public static void main(String[] args) {
        GraphDFSAdjList graph = null;
