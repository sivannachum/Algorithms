...
public class MatchingGraph {
    ...
    // Constructor
    // Name:    MatchingGraph
    // Input: 	the number of total vertices for the graph
    // Output:	none
    ...
    // Function
    // Name:    pokeToIndex
    // Input: 	Pokemon number from original graph
    // Output:	Index for that pokemon in the pokemon array
    //-------------------------------------
    ...
    // Function
    // Name:    addEdge
    // Input: 	if u is a trainer, then v is a pokemon, and weight is u's ranking of v
    ...
    // Input: 	none
    // Output:	Array of edges signifying matched pairs which create a stable matching
    //-------------------------------------
    ...
    //-------------------------------------
    // Function
    // Name:    writeStableEdgesToFile
    // Input: 	the name of the file to which to write the stable edges
