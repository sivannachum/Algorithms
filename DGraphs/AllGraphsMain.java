        ...
        while (true){
            ...
            // initialize an empty graph
                ...
                System.out.println("\nWhat kind of graph would you like to initialize?\n" + 
                                    ...
                                    "a = Adjacency List\n" +
                                    "e = Edge List\n" +
                                    "dm = Directed Adjacency Matrix\n" +
                                    "da = Directed Adjacency List\n" +
                                    "de = Directed Edge List");
            ...
            // convert to a different graph type
                ...
                if (graph instanceof GraphAdjMatrix){
                    ...
                    if (type.equals("a")){
                        ...
                        graph = tempGraph.convertToDirectedGraph();
                    }
                    else {
                        System.out.println("\nImproper input, try again.");
                    }
                ...
                else if (graph instanceof DGraphAdjMatrix){
                    DGraphAdjMatrix tempGraph = (DGraphAdjMatrix) graph;
                    System.out.println("\nda = Directed Adjacency List\n" +
                                        "de = Directed Edge List\n" +
                                        "u = Undirected Adjacency Matrix");
                    String type = scan.nextLine();
                    if (type.equals("da")){
                        graph = tempGraph.convertToDAdjList();
                    }
                    else if (type.equals("de")){
                        graph = tempGraph.convertToDEdgeList();
                    }
                    else if (type.equals("u")){
                        graph = tempGraph.convertToUndirectedGraph();
                    }
                    else {
                        System.out.println("\nImproper input, try again.");
                    }
                }
                else if (graph instanceof DGraphAdjList){
                    DGraphAdjList tempGraph = (DGraphAdjList) graph;
                    System.out.println("\ndm = Directed Adjacency Matrix\n" +
                                        "de = Directed Edge List\n" +
                                        "u = Undirected Adjacency List");
                    String type = scan.nextLine();
                    if (type.equals("dm")){
                        graph = tempGraph.convertToDAdjMatrix();
                    }
                    else if (type.equals("de")){
                        graph = tempGraph.convertToDEdgeList();
                    }
                ...
                else if (graph instanceof DGraphEdgeList) {
                    DGraphEdgeList tempGraph = (DGraphEdgeList) graph;
                    System.out.println("\ndm = Directed Adjacency Matrix\n" +
                                        "da = Directed Adjacency List\n" +
                                        "u = Undirected Edge List");
                    String type = scan.nextLine();
                    if (type.equals("dm")){
                        graph = tempGraph.convertToDAdjMatrix();
                    }
