...
// Author: 		Sivan Nachum
// Date: 		April 15, 2021
// Description:	Java code to create a directional weighted Graph representation via an edge list
//-----------------------------------------------------
...
public class DGraphEdgeList {
    ...
    public DGraphAdjMatrix convertToDAdjMatrix(){
        ...
        for (DEdge connection : edges){
            dAdjMatrix.addEdge(connection.getFirstVertex(), connection.getSecondVertex(), connection.getWeight());
        }
        return dAdjMatrix;
    }
}
